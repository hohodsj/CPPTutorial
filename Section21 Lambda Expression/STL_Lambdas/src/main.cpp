...
// Testswhether two triangles are equivalents.
...
// permutation of another using predicate lambda to compare points.
void test2() {
	std::cout << "\n\n---Test2 --------------------------" << std::endl;
    ...
    if(std::is_permutation(triangle1.begin(), triangle1.end(), triangle2.begin(), [] (Point lhs, Point rhs) {
        ...
        std::cout << "Triangle1 and 2 are equivalent" << std::endl;
    else
        std::cout << "Triangle1 and 2 are NOT equivalent" << std::endl;
    ...
    if(std::is_permutation(triangle1.begin(), triangle1.end(), triangle3.begin(), [] (Point lhs, Point rhs) {
        ...
        std::cout << "Triangle1 and 3 are equivalent" << std::endl;
    else
        std::cout << "Triangle1 and 3 are NOT equivalent" << std::endl;
}

// transform - Modifying sequence operation
// Similar to lambda "bonus" we defined earlier which awarded
// bonus point to test scores, the transform function applies whatever
// operation is defined within the passed lambda to each element of the sequence.
// In this case, each test score is increase by 5 points
void test3() {
	std::cout << "\n---Test3 --------------------------" << std::endl;
...
// the most common used of lambdas with the standard template library.
...
// in_between (is_all_in_between) used for test6
// all_of - Non-modifying sequence operation
// Tests whether all elements contained wihtin the sequence satisfy the
...
// all_of - Non-modifying sequence operation
// Tests whether all elements contains within the sequence satisfy the
// condition defined by the passed predicate lambda.
